...
+ Problems:
    ...
    + Material that was in the report is _only available for audited buildings in schools_.
...
# How to Model the Treatment Process

Ideal:

+ Very likely that the choice to install EEMs is based on energy use, not student characteristics.
+ Student characteristics may be correlated with energy use, or age of building, but that can't be tested with available data.
