...
# Add Fractional student population descriptions
...
Master %>%
  mutate(MalePct = Male / Enrollment,
         ...
         AsianPct = Asian / Enrollment) -> Master
...
stargazer(SimpleResults[[1]], SimpleResults[[2]],SimpleResults[[3]], SimpleResults[[4]], keep = c("Constant", "Eligible", "Treated"))
